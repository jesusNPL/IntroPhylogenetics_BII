...
# Getting phylogenies from the Open Tree of Life

A detailed example of how to get phylogenies from the **Open tree of Life** can be found [here](https://cran.r-project.org/web/packages/rotl/vignettes/rotl.html).
...
Getting the tree corresponding to the taxa 
